...
var AlarmClock = function (_Component) {
    inherits(AlarmClock, _Component);

    function AlarmClock(options) {
        classCallCheck(this, AlarmClock);
    ...
    AlarmClock.prototype.loadTime = function loadTime() {
        var _this2 = this;
        ...
        this.weekdays = days.map(function (day, i) {
            var cssClass = '';
            var oneBasedIndex = i + 1;
            if (oneBasedIndex === currentDay) {
                cssClass = 'active';
            }
            return { cssClass: cssClass, day: day };
        });
        setTimeout(function () {
            return _this2.loadTime();
        }, 1000);
    };
    // Actions


    AlarmClock.prototype.toggleTheme = function toggleTheme(e) {
        e.preventDefault();
        if (this.theme === 'dark') {
            this.theme = 'light';
        } else {
    ...
    AlarmClock.prototype.convertTimeToArray = function convertTimeToArray(time) {
        var times = {};
        time.split(':').forEach(function (time, i) {
            var key = 'hours';
            if (i === 1) {
                key = 'minutes';
            }
...
__decorate([tracked], AlarmClock.prototype, "theme", void 0);
__decorate([tracked], AlarmClock.prototype, "time", void 0);
__decorate([tracked], AlarmClock.prototype, "weekdays", void 0);

var __ui_components_alarm_clock_template__ = { "id": "+e27Nbwy", "block": "{\"symbols\":[\"digit\",\"digit\",\"digit\",\"weekday\"],\"prelude\":[[6,\"div\"]],\"head\":[[7]],\"statements\":[[0,\"\\n  \"],[6,\"div\"],[9,\"id\",\"clock\"],[10,\"class\",[26,[[18,\"theme\"]]]],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"display\"],[7],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"weekdays\"],[7],[0,\"\\n\"],[4,\"each\",[[19,0,[\"weekdays\"]]],[[\"key\"],[\"@index\"]],{\"statements\":[[0,\"          \"],[6,\"span\"],[10,\"class\",[26,[[19,4,[\"cssClass\"]]]]],[7],[1,[19,4,[\"day\"]],false],[8],[0,\"\\n\"]],\"parameters\":[4]},null],[0,\"      \"],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"alarm\"],[7],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"digits\"],[7],[0,\"\\n\"],[4,\"each\",[[19,0,[\"time\",\"hours\"]]],[[\"key\"],[\"@index\"]],{\"statements\":[[0,\"          \"],[6,\"div\"],[10,\"class\",[26,[[19,3,[]]]]],[7],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d1\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d2\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d3\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d4\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d5\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d6\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d7\"],[7],[8],[0,\"\\n          \"],[8],[0,\"\\n\"]],\"parameters\":[3]},null],[0,\"        \"],[6,\"div\"],[9,\"class\",\"dots\"],[7],[8],[0,\"\\n\"],[4,\"each\",[[19,0,[\"time\",\"minutes\"]]],[[\"key\"],[\"@index\"]],{\"statements\":[[0,\"          \"],[6,\"div\"],[10,\"class\",[26,[[19,2,[]]]]],[7],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d1\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d2\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d3\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d4\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d5\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d6\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d7\"],[7],[8],[0,\"\\n          \"],[8],[0,\"\\n\"]],\"parameters\":[2]},null],[0,\"        \"],[6,\"div\"],[9,\"class\",\"dots\"],[7],[8],[0,\"\\n\"],[4,\"each\",[[19,0,[\"time\",\"seconds\"]]],[[\"key\"],[\"@index\"]],{\"statements\":[[0,\"          \"],[6,\"div\"],[10,\"class\",[26,[[19,1,[]]]]],[7],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d1\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d2\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d3\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d4\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d5\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d6\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d7\"],[7],[8],[0,\"\\n          \"],[8],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"button-holder\"],[7],[0,\"\\n\\t\\t\"],[6,\"a\"],[9,\"href\",\"#\"],[9,\"class\",\"button\"],[10,\"onclick\",[25,\"action\",[[19,0,[\"toggleTheme\"]]],null],null],[7],[0,\"Switch Theme\"],[8],[0,\"\\n\\t\"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/countdown-component/components/alarm-clock", "<template-meta>": true } };
...
var CountdownComponent = function (_Component) {
    inherits(CountdownComponent, _Component);

    function CountdownComponent(options) {
        classCallCheck(this, CountdownComponent);
        ...
        var time = '12:00:00';
        if (_this.args.countdownDate) {
            dateStr = _this.args.countdownDate;
        }
        if (_this.args.countdownTime) {
            time = _this.args.countdownTime;
        }
        _this.countdownDateTime = dateStr + "T" + time;
        return _this;
    }
    // Methods


    CountdownComponent.prototype._loadTime = function _loadTime() {
        var _this2 = this;

        var now = +new Date();
        var expireDate = +new Date(this.countdownDateTime);
        var diffSeconds = (expireDate - now) / 1000;
        var months = Math.floor(diffSeconds / 86400 / 30.4167);
        var monthsInSeconds = months * 2592000;
        var days = Math.floor((diffSeconds - monthsInSeconds) / 86400);
        this.countdownTime = this._secondsToTime(diffSeconds);
        this.countdownDays = days;
        this.countdownMonths = months;
        setTimeout(function () {
            return _this2._loadTime();
        }, 1000);
    };

    CountdownComponent.prototype._secondsToTime = function _secondsToTime(sec) {
        var hours = Math.floor(sec % 86400 / 3600).toString();
        var minutes = Math.floor(sec % 86400 % 3600 / 60).toString();
        var seconds = Math.floor(sec % 86400 % 3600 % 60).toString();
...
__decorate$1([tracked], CountdownComponent.prototype, "countdownTime", void 0);
__decorate$1([tracked], CountdownComponent.prototype, "countdownDays", void 0);
__decorate$1([tracked], CountdownComponent.prototype, "countdownMonths", void 0);
__decorate$1([tracked], CountdownComponent.prototype, "theme", void 0);

var __ui_components_countdown_component_template__ = { "id": "4AYuNjOs", "block": "{\"symbols\":[\"digit\",\"digit\",\"digit\"],\"prelude\":[[6,\"div\"]],\"head\":[[7]],\"statements\":[[0,\"\\n  \"],[6,\"div\"],[9,\"id\",\"clock\"],[10,\"class\",[26,[[18,\"theme\"]]]],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"display\"],[7],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"weekdays\"],[7],[0,\"\\n        \"],[6,\"span\"],[9,\"class\",\"active\"],[7],[0,\"Months: \"],[1,[18,\"countdownMonths\"],false],[8],[0,\"\\n        \"],[6,\"span\"],[9,\"class\",\"active\"],[7],[0,\"Days: \"],[1,[18,\"countdownDays\"],false],[8],[0,\"\\n      \"],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"alarm\"],[7],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"digits\"],[7],[0,\"\\n\"],[4,\"each\",[[19,0,[\"countdownTime\",\"hours\"]]],[[\"key\"],[\"@index\"]],{\"statements\":[[0,\"          \"],[6,\"div\"],[10,\"class\",[26,[[19,3,[]]]]],[7],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d1\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d2\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d3\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d4\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d5\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d6\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d7\"],[7],[8],[0,\"\\n          \"],[8],[0,\"\\n\"]],\"parameters\":[3]},null],[0,\"        \"],[6,\"div\"],[9,\"class\",\"dots\"],[7],[8],[0,\"\\n\"],[4,\"each\",[[19,0,[\"countdownTime\",\"minutes\"]]],[[\"key\"],[\"@index\"]],{\"statements\":[[0,\"          \"],[6,\"div\"],[10,\"class\",[26,[[19,2,[]]]]],[7],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d1\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d2\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d3\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d4\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d5\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d6\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d7\"],[7],[8],[0,\"\\n          \"],[8],[0,\"\\n\"]],\"parameters\":[2]},null],[0,\"        \"],[6,\"div\"],[9,\"class\",\"dots\"],[7],[8],[0,\"\\n\"],[4,\"each\",[[19,0,[\"countdownTime\",\"seconds\"]]],[[\"key\"],[\"@index\"]],{\"statements\":[[0,\"          \"],[6,\"div\"],[10,\"class\",[26,[[19,1,[]]]]],[7],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d1\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d2\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d3\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d4\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d5\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d6\"],[7],[8],[0,\"\\n            \"],[6,\"span\"],[9,\"class\",\"d7\"],[7],[8],[0,\"\\n          \"],[8],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/countdown-component/components/countdown-component", "<template-meta>": true } };

var moduleMap = { 'component:/countdown-component/components/alarm-clock': AlarmClock, 'template:/countdown-component/components/alarm-clock': __ui_components_alarm_clock_template__, 'component:/countdown-component/components/countdown-component': CountdownComponent, 'template:/countdown-component/components/countdown-component': __ui_components_countdown_component_template__ };

var resolverConfiguration = { "app": { "name": "countdown-component", "rootName": "countdown-component" }, "types": { "application": { "definitiveCollection": "main" }, "component": { "definitiveCollection": "components" }, "helper": { "definitiveCollection": "components" }, "renderer": { "definitiveCollection": "main" }, "template": { "definitiveCollection": "components" } }, "collections": { "main": { "types": ["application", "renderer"] }, "components": { "group": "ui", "types": ["component", "template", "helper"], "defaultType": "component", "privateCollections": ["utils"] }, "styles": { "group": "ui", "unresolvable": true }, "utils": { "unresolvable": true } } };
...
app.boot();
initializeCustomElements(app, ['countdown-component', 'alarm-clock']);
